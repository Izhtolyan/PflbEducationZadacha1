...
// Создание почтового сервиса, обрабатывающего зарплаты.
        MailService<Integer> salaryService;
        salaryService = new MailService<>();
...
//Проверка почтового ящика
        ...
        assert Objects.equals(salaries.get(salary1.getTo()), List.of(1)) : "wrong salaries mailbox content (1)";
        assert salaries.get(salary2.getTo()).equals(List.of(Integer.MAX_VALUE)): "wrong salaries mailbox content (2)";
        assert List.of(randomSalary).equals(salaries.get(randomTo)): "wrong salaries mailbox content (3)";
    }
}